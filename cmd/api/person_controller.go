...
func (h handler) Save() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		person, err := h.personService.Save(personRequest.ToDomain())
		if err != nil {
...
func (h handler) VerifyEmail() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		err := h.personService.VerifyEmailByToken(token)
		if err != nil {
...
func (h handler) Login() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		person, token, err := h.personService.Login(personLogin.ToDomain())
		if err != nil {
...
func (h *handler) Update() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := h.personService.Update(id, req.ToDomain()); err != nil {
			h.HandleError(c, err)
			return
		}
...
func (h handler) validateRecoveryCode(code string) (string, error) {
	userID, err := h.personService.GetUserIDFromRecoveryCode(code)
	if err != nil {
		return "", err
	}
...
func (h handler) SendPasswordRecoveryEmail() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		err := h.personService.SendPasswordRecoveryEmail(request.Email)
		if err != nil {
			switch err {
...
func (h handler) RecoveryPassword() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if err := h.personService.CheckPasswordRecoveryByCode(request.Code); err != nil {
			h.HandleError(c, err)
			return
		}

		err = h.personService.RecoveryPassword(userID, request.NewPassword)
		if err != nil {
			h.HandleError(c, err)
			return
		}
